...
class Scraper(BeautifulSoup):
    ...
    def __get_data(self, players_hrefs):
        ...
        for href in players_hrefs:
            ...
            photo_url = self.find("img", class_="data-header__profile-image").get("src")
            ...
            league_country_file_name = league_country.replace(" ", "").lower() + ".png"
            ...
            download_image(league_country_file_url, headers, league_country_file_path)
